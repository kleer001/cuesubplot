...
Cuesubplot is a hardcoded (sadly not generalized yet) network generator for creating branching results reliably from local LLMs.  
...
Over a few months I had become increasing frustrated with the inability of the current crop of free online LLMs to manage generating very long and complicated multistep outputs, such as a 12-week program to learn a new skill like salesmanship or to generate a critique a famous song, line by line, from multiple angles. 
